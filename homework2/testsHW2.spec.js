describe('functionHW2.js -> positiveSum -> should find sum of positive number in array', function() {
...
describe('functionHW2.js -> evenOrOdd -> should return strings \'Even\' or  \'Odd\'', function() {
  it('Base test', function() {
...
describe('functionHW2.js -> centuryFromYear -> Input: year, output: century', function() {
  it('Base test', function() {
...
describe('functionHW2.js -> It should remove all values from list a, which are present in list b', function() {
